...
public class cabbageChef extends Mob {
	...
	public cabbageChef(int x, int y) {

		this.x = x;
		this.y = y;

		sprite = Sprite.cabbage_chef1;
	...
	public void render(Screen screen) {
		...
		if (animTimer % 30 > 15) {
			...
			sprite = Sprite.cabbage_chef2;
		}

		screen.renderAccurateSprite((int) x - 15, (int) y - 20, sprite, this);
	}
}
