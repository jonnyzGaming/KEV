...
public class CryingCabbagekid extends Mob {

	//basic stats
	private int animTimer;
	public static boolean activated = false;
	public static boolean talkedTo = false;

	public static int delayTimer = 0;

	public CryingCabbagekid(int x, int y) {

		this.x = x;
		this.y = y;

		sprite = Sprite.crying_cabbage_kid1;
	...
	public void render(Screen screen) {
		if (!talkedTo) {
			if (animTimer % 60 > 30) {
				...
				sprite = Sprite.crying_cabbage_kid2;
			}
		} else {
			if (animTimer % 60 > 30) {
				sprite = Sprite.crying_cabbage_kid_lollipop1;
			} else {
				sprite = Sprite.crying_cabbage_kid_lollipop2;
			}
