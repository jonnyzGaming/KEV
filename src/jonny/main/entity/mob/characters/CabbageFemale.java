...
public class CabbageFemale extends Mob {
	...
	public CabbageFemale(int x, int y) {

		this.x = x;
		this.y = y;

		sprite = Sprite.cabbage_female1;
	...
	public void render(Screen screen) {
		if (animTimer % 60 > 30) {
			...
			sprite = Sprite.cabbage_female2;
		}

		screen.renderObject((int) x - 16, (int) y - 16, sprite, this);
	}
}
