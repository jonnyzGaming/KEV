...
public class TeenCabbage extends Mob {
	//basic stats
	...
	public TeenCabbage(int x, int y) {

		this.x = x;
		this.y = y;

		sprite = Sprite.teen_cabbage1;
