...
public class RottenGooBall extends Projectile {

	public RottenGooBall(int x, int y, double dir) {
		super(x, y, dir);
	...
	public void update() {
		...
		if (entityCollision(Game.player, colBox)) {
			...
			Particle p = new Particle((int) x, (int) y, 7, 5, Sprite.rotton_goo_ball_particle);
